...
CapixIDE `v2.3.13` and Capix Code `v2.4.12`, the pinned customer releases with
...
```bash
CAPIX_STABLE_VERSION=v2.4.12 bash scripts/install.sh latest
```
