...
CapixIDE `v2.3.24` and Capix Code `v2.4.17`, the pinned customer releases with
...
```bash
CAPIX_STABLE_VERSION=v2.4.17 bash scripts/install.sh latest
```
